...
const FREQ_COLOR: Record<string, string> = { daily: "#22C55E", weekly: "#4DB5D6", biweekly: "#A855F7", monthly: "#F59E0B" };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="grid grid-cols-3 gap-3 flex-1">
          ...
          <Stat label={lb.due} value={stats.dueToday} color="#F59E0B" />
        </div>
        <div className="flex gap-2">
          ...
          {canManage && (
            <button onClick={() => setCreating(true)} className="px-4 py-2 bg-[#0072B8] hover:bg-[#0040B0] text-white rounded-xl text-sm font-medium flex items-center gap-2">
