  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-3 justify-between">
        ...
        {canEdit && (
          <button
            className="flex items-center gap-1.5 px-3 py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium rounded-lg"
                ...
                return (
                  <tr key={r.id} className="border-t border-gray-300 hover:bg-gray-50/50">
                    ...
                    <td className="px-4 py-3 text-center">
                      <span className={`px-2 py-0.5 rounded-full text-xs ${r.is_active ? "bg-green-100 text-green-700" : "bg-slate-100 text-gray-600"}`}>
