...
export default function IssuesPanel({ projects, members, filterProjectId = "all", canManage = true, refreshKey = 0 }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex rounded-xl overflow-hidden border border-[#334155] w-fit">
            ...
            <div key={i.id} className="bg-[#1E293B] border border-[#334155] rounded-xl p-4 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1 flex-wrap">
                  <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-slate-700/50 text-slate-300">{i.projects?.project_code || "—"}</span>
                  <span className="text-[10px] px-1.5 py-0.5 rounded text-white" style={{ background: SEV_COLOR[i.severity] }}>{SEV_LBL[i.severity]}</span>
              ...
              {canManage && (
                <div className="flex items-center gap-1">
                  ...
                  <button onClick={() => setEditing(i)} className="p-1.5 text-slate-400 hover:text-white"><Edit3 size={14} /></button>
