  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    articles: [
      ...
      },
      {
        ...
        content: {
          th: `ระบบดีลแบ่งเป็นขั้นตอน (Stages):\n• ลีดใหม่ → ติดต่อแล้ว → นำเสนอแล้ว → เจรจาต่อรอง → ส่งใบเสนอราคา → ได้รับ PO → ได้รับยอดชำระแล้ว → ปิดไม่สำเร็จ\n\nเมื่อดีลได้ "ได้รับ PO" ระบบจะ:\n1. สร้างโครงการใหม่อัตโนมัติ\n2. เชื่อมโยงกับลูกค้าในแท็บโครงการ\n\nข้อมูลดีล:\n• ชื่อผู้ติดต่อ — ชื่อคนติดต่อฝั่งลูกค้า\n• ช่องทางติดต่อ — เช่น LINE, โทรศัพท์, อีเมล\n• รายละเอียดที่ทำไปแล้ว — บันทึกสิ่งที่ดำเนินการแล้ว\n• สิ่งที่จะต้องทำต่อ — แผนงานขั้นถัดไป\n\nDetail Modal จะแสดงข้อมูลผู้ติดต่อ, งานที่ทำไปแล้ว, สิ่งที่ต้องทำต่อ เสมอ แม้ยังไม่กรอกข้อมูลก็จะแสดง "ยังไม่ระบุ"\n\nสมาชิก (Member) สร้างดีลจะตั้งเจ้าของเป็นตัวเองอัตโนมัติ\n\nสิทธิ์การจัดการ:\n• พนักงานแก้ไข/ลบได้เฉพาะดีลของตัวเอง หรือดีลที่ยอมรับเป็นผู้ร่วมงานแล้ว\n• ผู้จัดการ/แอดมินแก้ไข/ลบได้ทุกดีล\n\nชวนเพื่อน (Collaborators) + ระบบเชิญ:\n• เจ้าของดีลสามารถเชิญเพื่อนร่วมงานดีลเดียวกันได้\n• ผู้ถูกเชิญจะได้รับแจ้งเตือนอัตโนมัติ พร้อมปุ่มยอมรับ/ปฏิเสธ\n• แบนเนอร์คำเชิญรอตอบรับจะแสดงที่ด้านบนหน้า Pipeline\n• หลังยอมรับแล้ว ผู้ร่วมงานสามารถแก้ไขดีลได้เช่นเดียวกับเจ้าของ\n• สถานะผู้ร่วมงาน: รอตอบรับ (เหลือง) / ตอบรับแล้ว (เขียว) / ปฏิเสธ (แดง)\n• เจ้าของดีลจะได้รับแจ้งเตือนเมื่อผู้ถูกเชิญยอมรับหรือปฏิเสธ\n\nComment / ความคิดเห็น:\n• ผู้จัดการ/แอดมินใช้ Comment แนะนำและติดตามความคืบหน้า\n• เก็บประวัติความคิดเห็นทั้งหมดไว้ใน Detail ของดีล\n• รองรับแปลภาษา TH/EN/JP`,
          en: `The Deals system has pipeline stages:\n• New Lead → Contacted → Presented → Negotiating → Quotation Sent → PO Received → Payment Received → Closed Lost\n\nWhen a deal reaches "PO Received", the system:\n1. Auto-creates a new project\n2. Links it to the customer\n\nDeal Details:\n• Contact Person — customer-side contact name\n• Contact Channel — e.g. LINE, Phone, Email\n• Work Done — record of completed activities\n• Next Steps — plan for the next actions\n\nThe Detail Modal always shows contact info, work done, and next steps (shows "Not specified" when empty).\n\nMembers creating deals are automatically set as the owner.\n\nPermissions:\n• Members can only edit/delete their own deals or deals they've accepted as collaborator\n• Managers/admins can edit/delete any deal\n\nCollaborators + Invitation System:\n• Deal owners can invite teammates to collaborate on deals\n• Invited users receive a notification with accept/reject options\n• Pending invitations banner appears at the top of the Pipeline page\n• After accepting, collaborators can edit the deal just like the owner\n• Collaborator status: Pending (yellow) / Accepted (green) / Rejected (red)\n• Deal owners get notified when invitees accept or reject\n\nComments:\n• Managers/admins use comments to advise and track progress\n• Full comment history is stored in the deal detail view\n• Supports translation TH/EN/JP`,
          jp: `商談システムにはパイプラインステージがあります：\n• 新規リード → 連絡済み → 提案済み → 交渉中 → 見積送付 → PO受領 → 入金済み → 失注\n\n商談が「PO受領」に達すると、システムは：\n1. 新しいプロジェクトを自動作成\n2. 顧客にリンク\n\nメンバーがディールを作成すると、自動的にオーナーに設定されます。\n\n権限：\n• メンバーは自分のディールまたはコラボディールのみ編集/削除可能\n• マネージャー/管理者はすべてのディールを編集/削除可能\n\nコラボレーター：\n• ディールオーナーがチームメイトを招待して共同作業\n• コラボレーターはオーナーと同様にディールを編集可能\n\nコメント：\n• マネージャー/管理者がコメントでアドバイスと進捗追跡\n• ディール詳細にコメント履歴を完全保存\n• TH/EN/JP翻訳対応`,
        },
        tags: ["deal", "pipeline", "ดีล", "商談", "PO", "collaborator", "comment", "ชวนเพื่อน"],
      },
      {
        id: "quotations",
        title: { th: "ใบเสนอราคา", en: "Quotations", jp: "見積書" },
        content: {
          th: `สร้างใบเสนอราคาแบบมืออาชีพ พร้อมหัวกระดาษ CONSERTECH:\n\n1. คลิก "สร้างใบเสนอราคา"\n2. เลือกลูกค้า + ดีล\n3. เพิ่มรายการสินค้า/บริการ พร้อมราคา จำนวน ส่วนลด\n4. ระบุเงื่อนไข, วันหมดอายุ, หมายเหตุ\n5. บันทึก → ส่งอนุมัติ → หัวหน้าอนุมัติ → ดาวน์โหลด PDF\n\nรองรับส่วนลดแบบ % หรือจำนวนเงิน ทั้งรายรายการและรวม\n\nดาวน์โหลดได้ทั้ง PDF และ Excel`,
          en: `Create professional quotations with CONSERTECH letterhead:\n\n1. Click "Create Quotation"\n2. Select customer + deal\n3. Add line items with price, quantity, discount\n4. Set terms, expiry date, notes\n5. Save → Submit for approval → Manager approves → Download PDF\n\nSupports % or fixed amount discounts per item and overall.\n\nDownload as PDF or Excel.`,
          jp: `CONSERTECHレターヘッド付きのプロフェッショナルな見積書を作成：\n\n1.「見積書作成」をクリック\n2. 顧客 + 商談を選択\n3. 品目を追加（価格、数量、割引）\n4. 条件、有効期限、備考を設定\n5. 保存 → 承認申請 → マネージャー承認 → PDFダウンロード\n\n品目別および全体の%割引または金額割引に対応。\n\nPDFまたはExcelでダウンロード可能。`,
        },
    ...
    articles: [
      {
        ...
        content: {
          th: "คลังความรู้คือศูนย์รวมความรู้เกี่ยวกับงานและโปรเจคของบริษัท ครอบคลุมระบบ AGV/AMR, Robot, Industrial Sensors, Factory Automation, IoT, WMS, MES, PLC, Production Control และอื่นๆ\n\nฟีเจอร์หลัก:\n- จัดหมวดหมู่ 8 ประเภทตามประเภทงาน\n- ค้นหาบทความด้วยคำค้น\n- กรองตามหมวดหมู่และแท็ก\n- ปักหมุดบทความสำคัญ\n- นับจำนวนผู้อ่าน\n- AI ถาม-ตอบ จากคลังความรู้\n\nสิทธิ์การใช้งาน:\n- Admin/Manager: สร้าง แก้ไข ลบ บทความและหมวดหมู่\n- Member: อ่านบทความ + ใช้ AI ถาม-ตอบ",
          en: "The Knowledge Base is a centralized hub for company technical knowledge covering AGV/AMR, Robot, Industrial Sensors, Factory Automation, IoT, WMS, MES, PLC, Production Control and more.\n\nKey features:\n- 8 categories organized by work type\n- Search articles by keyword\n- Filter by category and tags\n- Pin important articles\n- View count tracking\n- AI Q&A from the knowledge base\n\nPermissions:\n- Admin/Manager: Create, edit, delete articles and categories\n- Member: Read articles + use AI Q&A",
          jp: "ナレッジベースは、AGV/AMR、Robot、産業センサー、工場自動化、IoT、WMS、MES、PLC、生産管理などの社内技術知識を集約したハブです。\n\n主な機能:\n- 業務タイプ別8カテゴリ\n- キーワードで記事検索\n- カテゴリとタグでフィルター\n- 重要記事のピン留め\n- 閲覧数の追跡\n- ナレッジベースからのAI Q&A\n\n権限:\n- 管理者/マネージャー: 記事とカテゴリの作成・編集・削除\n- メンバー: 記事の閲覧 + AI Q&Aの利用",
        },
